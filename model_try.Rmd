...
FPCs.pca <- prcomp(ddd[, c(5:7, 17:19, 32:33, 40,45)], center = TRUE,scale. = TRUE)
summary(FPCs.pca)
...
set.seed(1)
autoplot(kmeans(FPCs, 4), data = FPCs)

set.seed(2)
autoplot(kmeans(ddd[, c(5:7, 17:19, 32:33, 40,45)], 4), data = ddd)
```
